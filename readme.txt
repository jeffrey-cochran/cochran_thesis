cochran_thesis MATLAB Python Package
...
2. Installing the cochran_thesis Package

A. Change to the directory that contains the file setup.py and the subdirectory 
cochran_thesis. If you do not have write permissions, copy all its contents to a 
...
3. Using the cochran_thesis Package

The cochran_thesis package is on your Python path. To import it into a Python script or 
session, execute:

    import cochran_thesis
